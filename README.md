...
The first screen opens on **Threads**, a compact history view for branch lanes, checkpoints, and semantic diffstats. It gives you the context equivalent of a commit graph before you drill into branch proposals, Canon, or atom details.

<p align="center">
  <img src="assets/tui-cockpit.png" alt="Basin TUI cockpit showing branch lanes and checkpoint diffstats" width="920">
</p>
