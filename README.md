...
> **Status: alpha, under active development.** The engine, the Claude Code plugin, and the terminal UI work today and are covered by 138 passing tests. The detached LLM refiner and automatic fork detection are opt-in. See [Status](#status).
...
| **Tests** | ✅ **138 passing** (`engine/tests/`) |
