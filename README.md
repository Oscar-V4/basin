...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-124%20passing-brightgreen" alt="124 tests passing">
...
> **Status: alpha, under active development.** The engine, the Claude Code plugin, and the terminal UI work today and are covered by 124 passing tests. The detached LLM refiner and automatic fork detection are opt-in. See [Status](#status).
...
| **Tests** | ✅ **124 passing** (`engine/tests/`) |
